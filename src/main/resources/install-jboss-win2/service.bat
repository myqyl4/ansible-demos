...
REM      %JBOSS_HOME%\bin
REM      %JBOSS_HOME%\..\jbcs-httpd24-2.4\sbin
REM
...
set PRUNSRV=
if exist "%JBOSS_HOME%\..\jbcs-httpd24-2.4\sbin\prunsrv.exe" (
  set PRUNSRV="%JBOSS_HOME%\..\jbcs-httpd24-2.4\sbin\prunsrv.exe"
) else if exist "%JBOSS_HOME%\bin\prunsrv.exe" (
  set PRUNSRV="%JBOSS_HOME%\bin\prunsrv.exe"
) else (
  echo Please install native utilities into expected location %JBOSS_HOME%\..\jbcs-httpd24-2.4
  goto cmdEnd
)
